    ...
    return (
        <>
            <div className="grid grid-cols-1 md:h-screen md:grid-cols-2 h-dvh overflow-hidden
                            bg-app-primary text-app-t-primary bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]"
            >
